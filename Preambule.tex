...
\usepackage[version=3]{mhchem}
                          ...
                          % Ce package doit être en haut à cause d'un
                          % vieux bug qui cause une erreur sinon :( 
...
\usepackage{stmaryrd} % Encore des caractères de maths, cette fois c'est le symbole d'un intervalle d'entiers \llbracket -> [[
%\usepackage{amsthm}
\usepackage{xr-hyper} % Référence croisées entre fichiers
...
\usetikzlibrary{arrows,shapes,trees,calc,through,patterns,positioning,intersections,hobby} % loads some tikz extensions
...
%    \newacronym{cad}{CÀD}{C'est-à-dire}
    ...
    \newacronym{CNS}{CNS}{Condition Nécessaire et Suffisante}
    \newacronym{CVU}{CVU}{Converge Uniformément}
    \newacronym{CVS}{CVS}{Converge Simplement}
...
\mdfsetup{needspace=30pt, ntheorem, skipabove={1.2\baselineskip}, innertopmargin=0pt,skipbelow=10pt,leftmargin=-10mm, innerleftmargin=1mm, linecolor=black!80, outerlinewidth=1pt, topline=true, rightline=false, bottomline=false, frametitleaboveskip=-10pt} 
...
\mdfsetup{ 
    ntheorem, needspace=30pt,% skipabove={1.2\baselineskip}, skipbelow={0.5\baselineskip}, 
    innertopmargin=0pt,frametitleaboveskip=-10pt, leftmargin=0cm, innerleftmargin=2mm,leftline=true, linecolor=black!40,%
...
\mdfsetup{ 
  ntheorem, needspace=30pt, %skipabove={1.2\baselineskip}, skipbelow={0.5\baselineskip}, 
  innertopmargin=0pt,frametitleaboveskip=-10pt, leftmargin=0cm, innerleftmargin=2mm,leftline=true,outerlinewidth=0.5pt, linecolor=couleurGrisFonce, linewidth=1pt, topline=true, backgroundcolor=couleurGrisClair!40, rightline=true}%
...
\mdfsetup{skipabove=10pt, leftmargin=-2cm, rightmargin=-0.65cm, backgroundcolor=couleurClaire!15, linecolor=couleurFonce,
...
\newcommand{\CM}{\ensuremath{\mathcal{CPM}}}
...
\newcommand{\qed}{%
  \leavevmode\unskip\penalty9999 \hbox{}\nobreak\hfill
  \quad\hbox{\ensuremath{\Box}}} % Petit workaround de \qed...
